...
<div class="myprofile-wrapper">
  {!! Form::open(['url' => '/profile-update']) !!}
    @php
      ...
      echo "<img src='images/".$image."' class='myprofile-logo'>";
      ...
      echo "<label class='myprofile-bio'>Bio <textarea value='".$bio."' rows='3' name='bio'></textarea></label>";
      echo "<label class='myprofile-icon'>Icon Image <div class='file-style'><input type='file' name='file_image'><span>ファイルを選択</span></div></label>";
